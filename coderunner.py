...
openai_api_key = "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"
...
result = agent.invoke("buatlah matplotlib sederhana yang menampilkan fungsi sin dan tampilkan grafik plot nya")
print(result)